...
<table class="center">
    ...
    <tbody>
        <tr>
			...
			<td><a class="active" href="adjustWallet.php">Adjust Wallet Balance</a></td>
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	{
		echo '<div id="action">Please make your betting amount a number.</div>';
	}
	else
	{
		...
		else
		{
			...
			//The updated balance. Negative amounts are withdraws from the wallet balance.
			$amt4 = $wamt + $amt3;
			
			//Updates wallet balance
			$reg1 = "UPDATE wallets set balance = $amt4 WHERE walname = "."'"."$wname"."'".";";
			$reg2 = mysqli_query($conn,$reg1);
			echo '<div id="action">Your wallet is adjusted.</div>';
		}
	}
}
?>
